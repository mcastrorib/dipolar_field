...
echo g++ -shared -m64 -O3 -fopenmp -o "bin/dipolar_sum_core.so" "obj/pvm_misc.cpp.o" "obj/vec_3d.cpp.o" "obj/dipolar_sum.cpp.o" "obj/dipolar_sum_callers.cpp.o"
g++ -shared -m64 -O3 -fopenmp -o "bin/dipolar_sum_core.so" "obj/pvm_misc.cpp.o" "obj/vec_3d.cpp.o" "obj/dipolar_sum.cpp.o" "obj/dipolar_sum_callers.cpp.o"