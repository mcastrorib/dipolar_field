...
g++ -c -m64 -fPIC -O3 -fopenmp -I"include" "src/field_gradient.cpp" -o "obj/field_gradient.cpp.obj"
...
g++ -shared -m64 -O3 -fopenmp -o "bin/dipolar_sum_core.dll" "obj/pvm_misc.cpp.obj" "obj/vec_3d.cpp.obj" "obj/field_gradient.cpp.obj" "obj/dipolar_sum.cpp.obj" "obj/dipolar_sum_callers.cpp.obj"